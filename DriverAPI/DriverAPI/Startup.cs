...
using DriverRepository.Repository;
...
namespace DriverAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DriverContext>(o => o.UseSqlServer(Configuration.GetConnectionString("DriverDB")));
            services.AddTransient<IDriverRepository, DriverOperationRepository>();
        }
